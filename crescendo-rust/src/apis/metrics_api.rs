...
pub async fn get_metrics(configuration: &configuration::Configuration, days: Option<i32>) -> Result<models::MetricsResponse, Error<GetMetricsError>> {
    // add a prefix to parameters to efficiently prevent name collisions
    let p_query_days = days;

    let uri_str = format!("{}/api/v1/metrics", configuration.base_path);
