...
// checks if the AppSummaryResponse type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &AppSummaryResponse{}

// AppSummaryResponse struct for AppSummaryResponse
...
func (o AppSummaryResponse) ToMap() (map[string]interface{}, error) {
...
type NullableAppSummaryResponse struct {
	value *AppSummaryResponse
	isSet bool
}

func (v NullableAppSummaryResponse) Get() *AppSummaryResponse {
	return v.value
}

func (v *NullableAppSummaryResponse) Set(val *AppSummaryResponse) {
	v.value = val
	v.isSet = true
}

func (v NullableAppSummaryResponse) IsSet() bool {
	return v.isSet
}

func (v *NullableAppSummaryResponse) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableAppSummaryResponse(val *AppSummaryResponse) *NullableAppSummaryResponse {
	return &NullableAppSummaryResponse{value: val, isSet: true}
}

func (v NullableAppSummaryResponse) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableAppSummaryResponse) UnmarshalJSON(src []byte) error {
	v.isSet = true
