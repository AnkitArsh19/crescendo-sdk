...
// APIClient manages communication with the Crescendo API API vv1
...
type APIClient struct {
	...
	AppCatalogAPI *AppCatalogAPIService

	AudiencesContactsAPI *AudiencesContactsAPIService

	ConnectionsAPI *ConnectionsAPIService

	CustomEventsAPI *CustomEventsAPIService
...
func NewAPIClient(cfg *Configuration) *APIClient {
	...
	// API Services
	c.AppCatalogAPI = (*AppCatalogAPIService)(&c.common)
	c.AudiencesContactsAPI = (*AudiencesContactsAPIService)(&c.common)
	c.ConnectionsAPI = (*ConnectionsAPIService)(&c.common)
	c.CustomEventsAPI = (*CustomEventsAPIService)(&c.common)
