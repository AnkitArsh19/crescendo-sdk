...
class CreateWebhookRequest implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    public function setUrl($url)
    {
        ...
        if ((mb_strlen($url) < 1)) {
            throw new \InvalidArgumentException('invalid length for $url when calling CreateWebhookRequest., must be bigger than or equal to 1.');
        }
     ...
     *
     * @param string[] $subscribed_events subscribed_events
     *
     * @return self
     */
