...
class SendEmailRequest implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    public function setFrom($from)
    {
        ...
        if ((mb_strlen($from) < 1)) {
            throw new \InvalidArgumentException('invalid length for $from when calling SendEmailRequest., must be bigger than or equal to 1.');
        }
    ...
    public function setTo($to)
    {
        ...
        if ((mb_strlen($to) < 1)) {
            throw new \InvalidArgumentException('invalid length for $to when calling SendEmailRequest., must be bigger than or equal to 1.');
        }
