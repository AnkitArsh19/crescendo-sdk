...
class CreateTemplateRequest implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    public function setName($name)
    {
        ...
        if ((mb_strlen($name) > 255)) {
            throw new \InvalidArgumentException('invalid length for $name when calling CreateTemplateRequest., must be smaller than or equal to 255.');
        }
        if ((mb_strlen($name) < 0)) {
            throw new \InvalidArgumentException('invalid length for $name when calling CreateTemplateRequest., must be bigger than or equal to 0.');
        }
    ...
    public function setSubject($subject)
    {
        ...
        if ((mb_strlen($subject) > 1000)) {
            throw new \InvalidArgumentException('invalid length for $subject when calling CreateTemplateRequest., must be smaller than or equal to 1000.');
        }
        if ((mb_strlen($subject) < 0)) {
            throw new \InvalidArgumentException('invalid length for $subject when calling CreateTemplateRequest., must be bigger than or equal to 0.');
        }
    ...
    public function setHtmlBody($html_body)
    {
        ...
        if ((mb_strlen($html_body) < 1)) {
            throw new \InvalidArgumentException('invalid length for $html_body when calling CreateTemplateRequest., must be bigger than or equal to 1.');
        }
