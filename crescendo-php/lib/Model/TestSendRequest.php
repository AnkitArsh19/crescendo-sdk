...
/**
 * TestSendRequest Class Doc Comment
 *
 * @category Class
 * @package  Crescendo
 * @author   OpenAPI Generator team
 ...
 */
class TestSendRequest implements ModelInterface, ArrayAccess, \JsonSerializable
{
     ...
     * @var string
     */
    protected static $openAPIModelName = 'TestSendRequest';
    ...
    public function setToAddress($to_address)
    {
        ...
        if ((mb_strlen($to_address) < 1)) {
            throw new \InvalidArgumentException('invalid length for $to_address when calling TestSendRequest., must be bigger than or equal to 1.');
        }
