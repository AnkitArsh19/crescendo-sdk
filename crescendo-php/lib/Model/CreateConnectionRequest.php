...
class CreateConnectionRequest implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    public function listInvalidProperties()
    {
        ...
        if ((mb_strlen($this->container['app_key']) > 100)) {
            $invalidProperties[] = "invalid value for 'app_key', the character length must be smaller than or equal to 100.";
        }

        if ((mb_strlen($this->container['app_key']) < 0)) {
    ...
    public function setAppKey($app_key)
    {
        ...
        if ((mb_strlen($app_key) > 100)) {
            throw new \InvalidArgumentException('invalid length for $app_key when calling CreateConnectionRequest., must be smaller than or equal to 100.');
        }
        if ((mb_strlen($app_key) < 0)) {
            throw new \InvalidArgumentException('invalid length for $app_key when calling CreateConnectionRequest., must be bigger than or equal to 0.');
        }
    ...
    public function setName($name)
    {
        ...
        if ((mb_strlen($name) > 255)) {
            throw new \InvalidArgumentException('invalid length for $name when calling CreateConnectionRequest., must be smaller than or equal to 255.');
        }
        if ((mb_strlen($name) < 0)) {
            throw new \InvalidArgumentException('invalid length for $name when calling CreateConnectionRequest., must be bigger than or equal to 0.');
        }
