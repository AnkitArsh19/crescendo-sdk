...
class UpdateTemplateRequest implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    public function setSubject($subject)
    {
        ...
        if ((mb_strlen($subject) > 1000)) {
            throw new \InvalidArgumentException('invalid length for $subject when calling UpdateTemplateRequest., must be smaller than or equal to 1000.');
        }
        if ((mb_strlen($subject) < 0)) {
            throw new \InvalidArgumentException('invalid length for $subject when calling UpdateTemplateRequest., must be bigger than or equal to 0.');
        }
