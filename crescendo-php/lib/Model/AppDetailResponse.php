...
/**
 * AppDetailResponse Class Doc Comment
 *
 * @category Class
 * @package  Crescendo
 * @author   OpenAPI Generator team
 ...
 */
class AppDetailResponse implements ModelInterface, ArrayAccess, \JsonSerializable
{
     ...
     * @var string
     */
    protected static $openAPIModelName = 'AppDetailResponse';
     ...
     * Sets triggers
     *
     * @param array<string,mixed>[]|null $triggers triggers
     *
     * @return self
     */
     ...
     * Sets actions
     *
     * @param array<string,mixed>[]|null $actions actions
     *
     * @return self
     */
