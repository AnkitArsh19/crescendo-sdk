...
class ConnectionResponse implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    public function __construct(?array $data = null)
    {
        ...
        $this->setIfExists('granted_scopes', $data ?? [], null);
    }
     ...
     * Sets granted_scopes
     *
     * @param string|null $granted_scopes granted_scopes
     *
     * @return self
     */
    public function setGrantedScopes($granted_scopes)
    {
        if (is_null($granted_scopes)) {
            throw new \InvalidArgumentException('non-nullable granted_scopes cannot be null');
        }
