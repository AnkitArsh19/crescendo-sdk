...
[assembly: InternalsVisibleTo("Crescendo.Test")]
...
namespace Crescendo.Client
{
    ...
    public static partial class ClientUtils
    {
        ...
        public static string? ParameterToString(object? obj, string? format = ISO8601_DATETIME_FORMAT)
        {
            ...
            if (obj is bool boolean)
                return boolean
                    ? "true"
                    : "false";
            if (obj is AddDomainRequest.AllowedEmailTypeEnum addDomainRequestAllowedEmailTypeEnum)
                return AddDomainRequest.AllowedEmailTypeEnumToJsonValue(addDomainRequestAllowedEmailTypeEnum);
            if (obj is AddDomainRequest.CredentialSourceEnum addDomainRequestCredentialSourceEnum)
                return AddDomainRequest.CredentialSourceEnumToJsonValue(addDomainRequestCredentialSourceEnum);
            if (obj is SendBatchRequest.EmailTypeEnum sendBatchRequestEmailTypeEnum)
                return SendBatchRequest.EmailTypeEnumToJsonValue(sendBatchRequestEmailTypeEnum);
            if (obj is SendEmailRequest.EmailTypeEnum sendEmailRequestEmailTypeEnum)
                return SendEmailRequest.EmailTypeEnumToJsonValue(sendEmailRequestEmailTypeEnum);
            if (obj is SendTemplatedRequest.EmailTypeEnum sendTemplatedRequestEmailTypeEnum)
                return SendTemplatedRequest.EmailTypeEnumToJsonValue(sendTemplatedRequestEmailTypeEnum);
            if (obj is TemplateVariable.TypeEnum templateVariableTypeEnum)
                return TemplateVariable.TypeEnumToJsonValue(templateVariableTypeEnum);
        ...
        /// </summary>
        public const string BASE_ADDRESS = "https://api.crescendo.run";
        ...
        /// The host of the API
        /// </summary>
        public const string HOST = "api.crescendo.run";
