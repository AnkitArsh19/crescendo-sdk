...
additionalProperties:
  packageGuid: '{9A46104C-C6CF-404E-AB53-6F72D5CB049C}'
...
namespace YourProject
{
    public class Program
    {
        public static async Task Main(string[] args)
        {
            ...
            var api = host.Services.GetRequiredService<IAppCatalogApi>();
            IGetAppApiResponse apiResponse = await api.GetAppAsync("todo");
            AppDetailResponse? model = apiResponse.Ok();
        }
...
## Api Information
- appName: Crescendo API
- appVersion: v1
- appDescription: The Crescendo API powers workflow automation and transactional email at scale. Authenticate with a Bearer API key (prefix: &#x60;re_...&#x60;) obtained from the dashboard.
