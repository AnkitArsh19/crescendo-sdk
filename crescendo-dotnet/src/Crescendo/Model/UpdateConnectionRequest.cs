...
namespace Crescendo.Model
{
    ...
    public partial class UpdateConnectionRequest : IValidatableObject
    {
        ...
        [JsonConstructor]
        public UpdateConnectionRequest(Option<string?> name = default, Option<Dictionary<string, Object>?> credentials = default)
        {
            NameOption = name;
        ...
        [JsonIgnore]
        [global::System.ComponentModel.EditorBrowsable(global::System.ComponentModel.EditorBrowsableState.Never)]
        public Option<Dictionary<string, Object>?> CredentialsOption { get; private set; }

        /// <summary>
        /// Gets or Sets Credentials
        /// </summary>
        [JsonPropertyName("credentials")]
        public Dictionary<string, Object>? Credentials { get { return this.CredentialsOption.Value; } set { this.CredentialsOption = new(value); } }
    ...
    public class UpdateConnectionRequestJsonConverter : JsonConverter<UpdateConnectionRequest>
    {
        ...
        public override UpdateConnectionRequest Read(ref Utf8JsonReader utf8JsonReader, Type typeToConvert, JsonSerializerOptions jsonSerializerOptions)
        {
            ...
            if (credentials.IsSet && credentials.Value == null)
                throw new ArgumentNullException(nameof(credentials), "Property is not nullable for class UpdateConnectionRequest.");

            return new UpdateConnectionRequest(name, credentials);
        }
        ...
        public void WriteProperties(Utf8JsonWriter writer, UpdateConnectionRequest updateConnectionRequest, JsonSerializerOptions jsonSerializerOptions)
        {
            ...
            if (updateConnectionRequest.CredentialsOption.IsSet && updateConnectionRequest.Credentials == null)
                throw new ArgumentNullException(nameof(updateConnectionRequest.Credentials), "Property is required for class UpdateConnectionRequest.");

            if (updateConnectionRequest.NameOption.IsSet)
                writer.WriteString("name", updateConnectionRequest.Name);

            if (updateConnectionRequest.CredentialsOption.IsSet)
            {
                writer.WritePropertyName("credentials");
                JsonSerializer.Serialize(writer, updateConnectionRequest.Credentials, jsonSerializerOptions);
            }
        }
    }
}
