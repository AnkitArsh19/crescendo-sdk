...
# Unit tests for Crescendo::AddSuppressionRequest
# Automatically generated by openapi-generator (https://openapi-generator.tech)
# Please update as you see appropriate
describe Crescendo::AddSuppressionRequest do
  #let(:instance) { Crescendo::AddSuppressionRequest.new }

  describe 'test an instance of AddSuppressionRequest' do
    it 'should create an instance of AddSuppressionRequest' do
      # uncomment below to test the instance creation
      #expect(instance).to be_instance_of(Crescendo::AddSuppressionRequest)
    end
  end
